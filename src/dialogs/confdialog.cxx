...
Fl_Input_Choice *menuVoiceOSSDev=(Fl_Input_Choice *)0;

static void cb_menuVoiceOSSDev(Fl_Input_Choice* o, void*) {
  vscDevice[0] = vscDevice[1] = progdefaults.voiceOSSdevice = o->value();
resetSoundCard();
progdefaults.changed = true;
}
...
Fl_Choice *menuVoicePortInDev=(Fl_Choice *)0;

static void cb_menuVoicePortInDev(Fl_Choice* o, void*) {
  vscDevice[0] = progdefaults.VoicePortInDevice = o->text();
progdefaults.VoicePortInIndex = reinterpret_cast<intptr_t>(o->mvalue()->user_data());
resetSoundCard();
progdefaults.changed = true;
}

Fl_Choice *menuVoicePortOutDev=(Fl_Choice *)0;

static void cb_menuVoicePortOutDev(Fl_Choice* o, void*) {
  vscDevice[1] = progdefaults.VoicePortOutDevice = o->text();
...
Fl_Input2 *inpVoicePulseServer=(Fl_Input2 *)0;

static void cb_inpVoicePulseServer(Fl_Input2* o, void*) {
  vscDevice[0] = vscDevice[1] = progdefaults.VoicePulseServer = o->value();
resetSoundCard();
progdefaults.changed = true;
}
...
Fl_Choice *menuVoiceInSampleRate=(Fl_Choice *)0;

static void cb_menuVoiceInSampleRate(Fl_Choice* o, void*) {
  progdefaults.voice_in_sample_rate = o->value() > 1 ? strtol(o->mvalue()->text, 0, 10) : o->value();
resetSoundCard();
progdefaults.changed = true;
}

Fl_Choice *menuVoiceOutSampleRate=(Fl_Choice *)0;

static void cb_menuVoiceOutSampleRate(Fl_Choice* o, void*) {
  progdefaults.voice_out_sample_rate = o->value() > 1 ? strtol(o->mvalue()->text, 0, 10) : o->value();
resetSoundCard();
progdefaults.changed = true;
}
...
Fl_Double_Window* ConfigureDialog() {
  ...
  { Fl_Double_Window* o = new Fl_Double_Window(505, 460, _("Fldigi configuration"));
    w = o;
    o->color(FL_DARK2);
    o->selection_color((Fl_Color)51);
    o->labelsize(18);
    o->align(Fl_Align(FL_ALIGN_CLIP|FL_ALIGN_INSIDE));
    { tabsConfigure = new Fl_Tabs(0, 0, 505, 430);
      tabsConfigure->color(FL_LIGHT1);
      tabsConfigure->selection_color(FL_LIGHT1);
      { tabOperator = new Fl_Group(5, 25, 500, 345, _("Operator"));
        tabOperator->tooltip(_("Operator information"));
        tabOperator->callback((Fl_Callback*)cb_tabOperator);
        tabOperator->when(FL_WHEN_CHANGED);
        { Fl_Group* o = new Fl_Group(10, 35, 490, 165, _("Station"));
          o->box(FL_ENGRAVED_FRAME);
          o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
          { inpMyCallsign = new Fl_Input2(115, 64, 110, 24, _("Callsign:"));
          ...
          { inpMyName = new Fl_Input2(295, 64, 140, 24, _("Name:"));
          ...
          { inpMyQth = new Fl_Input2(115, 98, 320, 24, _("QTH:"));
          ...
          { inpMyLocator = new Fl_Input2(115, 133, 85, 24, _("Locator:"));
        ...
        { inpMyAntenna = new Fl_Input2(115, 167, 320, 24, _("Antenna:"));
        ...
        { grpNoise = new Fl_Group(10, 203, 490, 165, _("Test Signal - Do NOT use with transmitter"));
          grpNoise->box(FL_ENGRAVED_FRAME);
          grpNoise->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
          grpNoise->hide();
          { Fl_Check_Button* o = btnNoiseOn = new Fl_Check_Button(48, 241, 70, 15, _("Noise on"));
          ...
          { Fl_Counter2* o = noiseDB = new Fl_Counter2(45, 279, 89, 21, _("dB"));
            noiseDB->type(1);
      ...
      { tabUI = new Fl_Group(5, 25, 500, 346, _("UI"));
        tabUI->hide();
        { tabsUI = new Fl_Tabs(5, 25, 500, 346);
          tabsUI->selection_color(FL_LIGHT1);
          { tabUserInterface = new Fl_Group(5, 50, 500, 320, _("Gen\'"));
            { Fl_Group* o = new Fl_Group(7, 55, 496, 59);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Check_Button* o = btnShowTooltips = new Fl_Check_Button(25, 61, 120, 20, _("Show tooltips"));
              ...
              { Fl_Check_Button* o = chkMenuIcons = new Fl_Check_Button(160, 61, 150, 20, _("Show menu icons"));
              ...
              { mnuScheme = new Fl_Choice(160, 87, 80, 20, _("UI scheme"));
              ...
              { bVisibleModes = new Fl_Button(25, 87, 110, 20, _("Visible modes"));
              ...
              { mnuLang = new Fl_Choice(370, 87, 110, 20, _("UI language"));
            ...
            { Fl_Group* o = new Fl_Group(7, 114, 496, 150, _("QSO logging"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = btnNagMe = new Fl_Check_Button(24, 136, 236, 20, _("Prompt to save log"));
              ...
              { Fl_Check_Button* o = btnClearOnSave = new Fl_Check_Button(24, 159, 236, 20, _("Clear on save"));
              ...
              { Fl_Check_Button* o = btnAutoFillQSO = new Fl_Check_Button(24, 182, 236, 20, _("Auto-fill Country and Azimuth"));
              ...
              { Fl_Check_Button* o = btnCallUpperCase = new Fl_Check_Button(24, 205, 236, 20, _("Convert callsign to upper case"));
              ...
              { Fl_Check_Button* o = btnDateTimeSort = new Fl_Check_Button(277, 136, 190, 20, _("Sort by Date/Time OFF"));
              ...
              { Fl_Check_Button* o = btndate_time_force = new Fl_Check_Button(277, 159, 190, 20, _("Date time ON == OFF"));
              ...
              { Fl_Input2* o = inpMyPower = new Fl_Input2(277, 182, 50, 24, _("Transmit Power"));
                ...
                inpMyPower->align(Fl_Align(FL_ALIGN_RIGHT));
                inpMyPower->when(FL_WHEN_RELEASE);
                o->value(progdefaults.mytxpower.c_str());
                o->labelsize(FL_NORMAL_SIZE);
              } // Fl_Input2* inpMyPower
              { Fl_Check_Button* o = btnRSTdefault = new Fl_Check_Button(24, 228, 236, 20, _("Default RST out to 599"));
            ...
            { Fl_Group* o = new Fl_Group(7, 265, 496, 100, _("Text Capture"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = btnRXClicks = new Fl_Check_Button(24, 318, 313, 20, _("Double-click on RX text enters QSO data"));
              ...
              { Fl_Check_Button* o = btnRXTooltips = new Fl_Check_Button(24, 340, 313, 20, _("Show callsign tooltips in received text"));
              ...
              { Fl_Input2* o = inpNonword = new Fl_Input2(24, 286, 340, 24, _("Word delimiters"));
...
ab and newline are automatically included."));
                ...
                inpNonword->align(Fl_Align(FL_ALIGN_RIGHT));
          ...
          { tabBrowser = new Fl_Group(5, 50, 500, 320, _("Browser"));
            tabBrowser->hide();
            { Fl_Group* o = new Fl_Group(7, 59, 496, 300);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Spinner2* o = cntChannels = new Fl_Spinner2(23, 69, 50, 24, _("Channels, first channel starts at waterfall lower limit"));
              ...
              { Fl_Spinner2* o = cntTimeout = new Fl_Spinner2(23, 105, 50, 24, _("Inactivity timeout"));
              ...
              { mnuViewerLabel = new Fl_Choice(23, 145, 150, 24, _("Channel label"));
              ...
              { btnViewerFont = new Fl_Button(308, 145, 70, 24, _("Font..."));
                btnViewerFont->tooltip(_("select browser font"));
                btnViewerFont->callback((Fl_Callback*)cb_btnViewerFont);
              } // Fl_Button* btnViewerFont
              { Fl_Check_Button* o = btnFixedIntervals = new Fl_Check_Button(213, 131, 165, 20, _("Fixed Intervals"));
              ...
              { Fl_Check_Button* o = btnMarquee = new Fl_Check_Button(23, 183, 165, 20, _("Continuous scrolling"));
              ...
              { Fl_Check_Button* o = btnAscend = new Fl_Check_Button(23, 207, 253, 20, _("Lowest freq on bottom of viewer"));
              ...
              { Fl_Check_Button* o = btnBrowserHistory = new Fl_Check_Button(23, 232, 356, 20, _("Play back history when active channel selected"));
              ...
              { Fl_Group* o = new Fl_Group(25, 265, 219, 60, _("Detection Level Colors"));
                o->box(FL_ENGRAVED_FRAME);
                o->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
                { bwsrSliderColor = new Fl_Button(48, 288, 80, 24, _("Backgnd"));
                ...
                { bwsrSldrSelColor = new Fl_Button(140, 288, 80, 24, _("Button"));
          ...
          { tabMBars = new Fl_Group(5, 50, 500, 320, _("Macros"));
            tabMBars->hide();
            { Fl_Group* o = new Fl_Group(7, 250, 496, 40);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Check_Button* o = btnMacroMouseWheel = new Fl_Check_Button(17, 259, 296, 20, _("Mouse wheel active on macro buttons"));
            ...
            { Fl_Group* o = new Fl_Group(7, 292, 496, 76);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Check_Button* o = btnUseLastMacro = new Fl_Check_Button(17, 302, 277, 20, _("Load last used macro file on startup"));
              ...
              { Fl_Check_Button* o = btnDisplayMacroFilename = new Fl_Check_Button(17, 331, 277, 20, _("Display macro filename on startup"));
          ...
          { tabContest = new Fl_Group(5, 50, 500, 320, _("Contest"));
            tabContest->hide();
            { Fl_Group* o = new Fl_Group(10, 60, 490, 80, _("Exchanges"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { lblSend = new Fl_Box(42, 95, 55, 20, _("Send:"));
              } // Fl_Box* lblSend
              { Fl_Input2* o = inpSend1 = new Fl_Input2(100, 95, 140, 20, _("Exchange Out"));
              ...
              { Fl_Check_Button* o = btn599 = new Fl_Check_Button(315, 80, 130, 20, _("RST always 599"));
              ...
              { Fl_Check_Button* o = btnCutNbrs = new Fl_Check_Button(315, 110, 180, 20, _("Send CW cut numbers"));
            ...
            { Fl_Group* o = new Fl_Group(10, 150, 490, 65, _("Serial number"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { btnUseLeadingZeros = new Fl_Check_Button(31, 176, 154, 20, _("Use leading zeros"));
              ...
              { Fl_Value_Input2* o = nbrContestStart = new Fl_Value_Input2(226, 176, 45, 20, _("Start"));
              ...
              { nbrContestDigits = new Fl_Value_Input2(308, 175, 45, 20, _("Digits"));
              ...
              { btnResetSerNbr = new Fl_Button(400, 176, 70, 20, _("Reset"));
            ...
            { Fl_Group* o = new Fl_Group(10, 225, 490, 130, _("Duplicate check, CALL plus"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Light_Button* o = btnDupCheckOn = new Fl_Light_Button(20, 255, 74, 20, _("On/Off"));
              ...
              { Fl_Check_Button* o = btnDupBand = new Fl_Check_Button(161, 255, 70, 20, _("Band"));
              ...
              { Fl_Check_Button* o = btnDupMode = new Fl_Check_Button(281, 255, 70, 20, _("Mode"));
              ...
              { Fl_Check_Button* o = btnDupState = new Fl_Check_Button(400, 255, 70, 20, _("State"));
              ...
              { Fl_Check_Button* o = btnDupXchg1 = new Fl_Check_Button(161, 283, 105, 20, _("Exchange In"));
              ...
              { Fl_Check_Button* o = btnDupTimeSpan = new Fl_Check_Button(161, 313, 129, 20, _("Time span over"));
              ...
              { Fl_Value_Input2* o = nbrTimeSpan = new Fl_Value_Input2(290, 313, 53, 20, _("minutes"));
              ...
              { Fl_Button* o = btnDupColor = new Fl_Button(20, 282, 90, 22, _("Dup Color"));
          ...
          { tabWF_UI = new Fl_Group(5, 50, 500, 320, _("WF Ctrls"));
            tabWF_UI->hide();
            { Fl_Group* o = new Fl_Group(7, 58, 496, 253);
              o->box(FL_ENGRAVED_BOX);
              { Fl_Box* o = new Fl_Box(36, 65, 446, 25, _("Enable check box to show each respective operator control"));
                o->box(FL_FLAT_BOX);
                o->align(Fl_Align(FL_ALIGN_CENTER|FL_ALIGN_INSIDE));
              } // Fl_Box* o
              { Fl_Check_Button* o = btnWF_UIrev = new Fl_Check_Button(63, 98, 150, 20, _("Reverse"));
              ...
              { Fl_Check_Button* o = btnWF_UIx1 = new Fl_Check_Button(282, 98, 162, 20, _("WF Magnification"));
              ...
              { Fl_Check_Button* o = btnWF_UIwfcarrier = new Fl_Check_Button(63, 129, 150, 20, _("WF carrier"));
              ...
              { Fl_Check_Button* o = btnWF_UIwfshift = new Fl_Check_Button(282, 129, 150, 20, _("WF Shift Controls"));
              ...
              { Fl_Check_Button* o = btnWF_UIwfreflevel = new Fl_Check_Button(63, 161, 150, 20, _("WF ref level"));
              ...
              { Fl_Check_Button* o = btnWF_UIwfdrop = new Fl_Check_Button(282, 161, 150, 20, _("WF drop rate"));
              ...
              { Fl_Check_Button* o = btnWF_UIwfampspan = new Fl_Check_Button(63, 193, 150, 20, _("WF amp span"));
              ...
              { Fl_Check_Button* o = btnWF_UIwfstore = new Fl_Check_Button(282, 193, 150, 20, _("WF Store"));
              ...
              { Fl_Check_Button* o = btnWF_UIwfmode = new Fl_Check_Button(63, 225, 150, 20, _("WF mode"));
              ...
              { Fl_Check_Button* o = btnWF_UIqsy = new Fl_Check_Button(282, 225, 150, 20, _("QSY"));
              ...
              { Fl_Check_Button* o = btnWF_UIxmtlock = new Fl_Check_Button(282, 257, 150, 20, _("XMT lock"));
              ...
              { btn_wf_enable_all = new Fl_Button(107, 280, 88, 20, _("Enable all"));
                btn_wf_enable_all->callback((Fl_Callback*)cb_btn_wf_enable_all);
              } // Fl_Button* btn_wf_enable_all
              { btn_wf_disable_all = new Fl_Button(306, 280, 88, 20, _("Disable all"));
          ...
          { tabRxText = new Fl_Group(5, 50, 500, 320, _("Rx Text"));
            tabRxText->hide();
            { Fl_Check_Button* o = btn_rx_lowercase = new Fl_Check_Button(32, 75, 389, 20, _("Print CW / RTTY / THROB / CONTESTIA in lowercase"));
          ...
          { tabLogServer = new Fl_Group(5, 50, 500, 320, _("Log server"));
            tabLogServer->hide();
            { Fl_Group* o = new Fl_Group(10, 60, 490, 147, _("Client/Server Logbook"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Input* o = xmllogServerAddress = new Fl_Input(144, 85, 180, 25, _("Server Address:"));
              ...
              { Fl_Input* o = xmllogServerPort = new Fl_Input(144, 121, 98, 25, _("Server Port:"));
              ...
              { btn_reconnect_log_server = new Fl_Button(199, 156, 115, 26, _("Reconnect"));
      ...
      { tabWaterfall = new Fl_Group(5, 25, 500, 365, _("Waterfall"));
        tabWaterfall->hide();
        { tabsWaterfall = new Fl_Tabs(5, 25, 500, 365);
          tabsWaterfall->color(FL_LIGHT1);
          tabsWaterfall->selection_color(FL_LIGHT1);
          { Fl_Group* o = new Fl_Group(5, 50, 500, 320, _("Display"));
            { Fl_Group* o = new Fl_Group(10, 60, 495, 162, _("Colors and cursors"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { colorbox* o = WF_Palette = new colorbox(20, 93, 260, 24, _("aa"));
              ...
              { Fl_Button* o = btnCursorBWcolor = new Fl_Button(20, 172, 20, 20, _("Cursor color"));
              ...
              { Fl_Check_Button* o = btnUseCursorCenterLine = new Fl_Check_Button(190, 149, 149, 20, _("Cursor center line"));
              ...
              { Fl_Button* o = btnCursorCenterLineColor = new Fl_Button(190, 172, 20, 20, _("Center line color"));
              ...
              { Fl_Check_Button* o = btnUseBWTracks = new Fl_Check_Button(351, 149, 145, 20, _("Bandwidth tracks"));
              ...
              { Fl_Button* o = btnBwTracksColor = new Fl_Button(351, 172, 20, 20, _("Tracks color"));
              ...
              { Fl_Check_Button* o = btnUseWideTracks = new Fl_Check_Button(351, 196, 145, 20, _("Wide tracks"));
              ...
              { Fl_Check_Button* o = btnUseWideCenter = new Fl_Check_Button(190, 197, 145, 20, _("Wide center line"));
              ...
              { Fl_Check_Button* o = btnUseWideCursor = new Fl_Check_Button(20, 195, 145, 20, _("Wide cursor"));
            ...
            { Fl_Group* o = new Fl_Group(10, 222, 490, 62, _("Frequency scale"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = chkShowAudioScale = new Fl_Check_Button(20, 252, 240, 20, _("Always show audio frequencies"));
              ...
              { btnWaterfallFont = new Fl_Button(319, 252, 70, 24, _("Font..."));
            ...
            { Fl_Group* o = new Fl_Group(10, 285, 490, 80, _("Transmit signal"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = btnViewXmtSignal = new Fl_Check_Button(20, 315, 205, 20, _("Monitor transmitted signal"));
              ...
              { Fl_Value_Slider2* o = valTxMonitorLevel = new Fl_Value_Slider2(275, 315, 200, 20, _("Signal level"));
          ...
          { Fl_Group* o = new Fl_Group(5, 50, 500, 320, _("FFT Processing"));
            o->hide();
            { Fl_Group* o = new Fl_Group(10, 62, 490, 135);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Counter2* o = cntLowFreqCutoff = new Fl_Counter2(55, 72, 70, 20, _("Lower limit"));
              ...
              { Fl_Counter2* o = valLatency = new Fl_Counter2(55, 102, 70, 21, _("FFT latency (scan merging)"));
...
an merging"));
              ...
              { Fl_Check_Button* o = btnWFaveraging = new Fl_Check_Button(55, 133, 120, 20, _("FFT averaging"));
              ...
              { mnuFFTPrefilter = new Fl_Choice(55, 163, 120, 25, _("FFT prefilter window function"));
              ...
              { Fl_Counter2* o = cntrWfwidth = new Fl_Counter2(278, 72, 95, 21, _("Upper limit"));
            ...
            { Fl_Group* o = new Fl_Group(10, 212, 490, 80, _("Changes take effect on next program startup"));
              o->tooltip(_("Show me more or less waterfall"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
              { Fl_Counter2* o = cntrWfheight = new Fl_Counter2(55, 242, 95, 21, _("Waterfall height in pixels"));
          ...
          { Fl_Group* o = new Fl_Group(5, 50, 500, 320, _("Mouse"));
            o->hide();
            { Fl_Group* o = new Fl_Group(10, 62, 490, 170);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Check_Button* o = btnWaterfallHistoryDefault = new Fl_Check_Button(20, 76, 340, 20, _("Left or right click always replays audio history"));
              ...
              { Fl_Check_Button* o = btnWaterfallQSY = new Fl_Check_Button(20, 106, 380, 20, _("Dragging on the waterfall scale changes frequency"));
              ...
              { Fl_Check_Button* o = btnWaterfallClickInsert = new Fl_Check_Button(20, 148, 225, 20, _("Insert text on single left click"));
              ...
              { inpWaterfallClickText = new Fl_Input2(306, 136, 180, 50);
            ...
            { mnuWaterfallWheelAction = new Fl_Choice(20, 196, 150, 22, _("Wheel action"));
      ...
      { tabModems = new Fl_Group(1, 25, 504, 365, _("Modems"));
        tabModems->hide();
        { tabsModems = new Fl_Tabs(1, 25, 504, 365);
          tabsModems->selection_color(FL_LIGHT1);
          tabsModems->align(Fl_Align(FL_ALIGN_TOP_RIGHT));
          { tabContestia = new Fl_Group(5, 50, 500, 320, _("Contestia"));
            tabContestia->hide();
            { Fl_Group* o = new Fl_Group(10, 60, 490, 200);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Choice* o = mnuContestia_Bandwidth = new Fl_Choice(65, 80, 85, 20, _("Bandwidth"));
              ...
              { Fl_Choice* o = mnuContestia_Tones = new Fl_Choice(326, 80, 70, 20, _("Tones"));
              ...
              { Fl_Group* o = new Fl_Group(65, 119, 379, 100, _("Receive synchronizer"));
                o->box(FL_ENGRAVED_FRAME);
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
                { Fl_Counter2* o = cntContestia_smargin = new Fl_Counter2(85, 150, 70, 20, _("Tune margin (tone frequency spacing)"));
                ...
                { Fl_Counter2* o = cntContestia_sinteg = new Fl_Counter2(85, 180, 70, 20, _("Integration period (FEC blocks)"));
              ...
              { btnContestia_8bit = new Fl_Check_Button(65, 229, 200, 20, _("8-bit extended characters"));
          ...
          { tabCW = new Fl_Group(5, 50, 500, 320, _("CW"));
            tabCW->hide();
            { tabsCW = new Fl_Tabs(5, 50, 500, 320);
              tabsCW->selection_color(FL_LIGHT1);
              { Fl_Group* o = new Fl_Group(5, 75, 500, 295, _("General"));
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT));
                { Fl_Group* o = new Fl_Group(10, 85, 490, 130, _("Receive"));
                o->box(FL_ENGRAVED_FRAME);
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
                { Fl_Value_Slider2* o = sldrCWbandwidth = new Fl_Value_Slider2(45, 115, 290, 20, _("Filter bandwidth"));
                ...
                { Fl_Check_Button* o = btnCWrcvTrack = new Fl_Check_Button(45, 150, 80, 20, _("Tracking"));
                ...
                { Fl_Counter2* o = cntCWrange = new Fl_Counter2(230, 150, 65, 20, _("Tracking range (WPM)"));
                ...
                { Fl_Box* o = new Fl_Box(365, 185, 70, 20, _("RX WPM"));
                o->align(Fl_Align(FL_ALIGN_LEFT|FL_ALIGN_INSIDE));
                } // Fl_Box* o
                o->end();
                } // Fl_Group* o
                { Fl_Group* o = new Fl_Group(10, 215, 490, 150, _("Transmit"));
                o->box(FL_ENGRAVED_FRAME);
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
                { Fl_Value_Slider2* o = sldrCWxmtWPM = new Fl_Value_Slider2(25, 240, 400, 20, _("TX WPM"));
                ...
                { Fl_Counter2* o = cntCWdefWPM = new Fl_Counter2(45, 281, 64, 20, _("Default"));
                ...
                { Fl_Counter* o = cntCWlowerlimit = new Fl_Counter(202, 281, 65, 20, _("Lower limit"));
                ...
                { Fl_Counter* o = cntCWupperlimit = new Fl_Counter(360, 281, 65, 20, _("Upper limit"));
                ...
                { Fl_Value_Slider2* o = sldrCWfarnsworth = new Fl_Value_Slider2(25, 335, 400, 20, _("F-WPM"));
                ...
                { Fl_Check_Button* o = btnCWusefarnsworth = new Fl_Check_Button(45, 312, 180, 15, _("Use Farnsworth timing"));
              ...
              { Fl_Group* o = new Fl_Group(5, 75, 500, 295, _("Timing and QSK"));
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT));
                o->hide();
                { Fl_Group* o = new Fl_Group(10, 85, 490, 120, _("Timing"));
                o->box(FL_ENGRAVED_FRAME);
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
                { Fl_Counter2* o = cntCWweight = new Fl_Counter2(20, 114, 65, 20, _("Weight (%)"));
                ...
                { Fl_Counter2* o = cntCWdash2dot = new Fl_Counter2(245, 114, 64, 20, _("Dash to dot ratio"));
                ...
                { Fl_Counter2* o = cntCWrisetime = new Fl_Counter2(245, 145, 65, 20, _("Edge timing"));
                ...
                { Fl_Choice* o = mnuQSKshape = new Fl_Choice(20, 144, 112, 20, _("Edge shape"));
                ...
                { Fl_Check_Button* o = btnCWnarrow = new Fl_Check_Button(20, 175, 225, 15, _("Edge decreases pulse width"));
                ...
                { Fl_Group* o = new Fl_Group(10, 217, 490, 118, _("QSK"));
                o->box(FL_ENGRAVED_FRAME);
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
                { Fl_Check_Button* o = btnQSK = new Fl_Check_Button(20, 245, 211, 20, _("QSK on right audio channel"));
                ...
                { Fl_Counter2* o = cntPreTiming = new Fl_Counter2(20, 275, 64, 20, _("Pre-keydown timing (ms)"));
                ...
                { Fl_Counter2* o = cntPostTiming = new Fl_Counter2(20, 305, 64, 20, _("Post-keydown timing (ms)"));
                ...
                { Fl_Check_Button* o = btnQSKadjust = new Fl_Check_Button(295, 275, 160, 20, _("Send continuously"));
                ...
                { Fl_Choice* o = mnuTestChar = new Fl_Choice(295, 245, 41, 20, _("Test char"));
              ...
              { Fl_Group* o = new Fl_Group(5, 75, 500, 295, _("Prosigns"));
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT));
                o->hide();
                { Fl_Group* o = new Fl_Group(9, 81, 492, 283);
                o->box(FL_ENGRAVED_FRAME);
                { Fl_Check_Button* o = btnCW_use_paren = new Fl_Check_Button(240, 236, 68, 15, _("Use \'(\' paren not KN"));
                ...
                { Fl_Choice* o = mnu_prosign[0] = new Fl_Choice(172, 94, 47, 22, _("<BT>"));
                ...
                { Fl_Choice* o = mnu_prosign[1] = new Fl_Choice(172, 121, 47, 22, _("<AA>"));
                ...
                { Fl_Choice* o = mnu_prosign[2] = new Fl_Choice(172, 149, 47, 22, _("<AS>"));
                ...
                { Fl_Choice* o = mnu_prosign[3] = new Fl_Choice(172, 176, 47, 22, _("<AR>"));
                ...
                { Fl_Choice* o = mnu_prosign[4] = new Fl_Choice(172, 204, 47, 22, _("<SK>"));
                ...
                { Fl_Choice* o = mnu_prosign[5] = new Fl_Choice(172, 232, 47, 22, _("<KN>"));
                ...
                { Fl_Choice* o = mnu_prosign[6] = new Fl_Choice(172, 259, 47, 22, _("<INT>"));
                ...
                { Fl_Choice* o = mnu_prosign[7] = new Fl_Choice(172, 287, 47, 22, _("<HM>"));
                ...
                { Fl_Choice* o = mnu_prosign[8] = new Fl_Choice(172, 315, 47, 22, _("<VE>"));
          ...
          { tabDomEX = new Fl_Group(5, 50, 500, 320, _("Dom"));
            tabDomEX->hide();
            { Fl_Group* o = new Fl_Group(10, 60, 490, 180);
              o->box(FL_ENGRAVED_FRAME);
              { txtSecondary = new Fl_Input2(20, 87, 360, 40, _("Secondary Text"));
              ...
              { Fl_Check_Button* o = valDominoEX_FILTER = new Fl_Check_Button(20, 141, 80, 20, _("Filtering"));
              ...
              { Fl_Counter2* o = valDominoEX_BW = new Fl_Counter2(161, 141, 63, 20, _("Filter bandwidth factor"));
              ...
              { Fl_Check_Button* o = chkDominoEX_FEC = new Fl_Check_Button(20, 171, 51, 20, _("FEC"));
              ...
              { Fl_Value_Slider2* o = valDomCWI = new Fl_Value_Slider2(20, 207, 260, 20, _("CWI threshold"));
              ...
              { Fl_Counter2* o = valDominoEX_PATHS = new Fl_Counter2(344, 194, 63, 20, _("Paths (hidden)"));
          ...
          { tabFeld = new Fl_Group(5, 50, 500, 320, _("FH"));
            tabFeld->hide();
            { Fl_Group* o = new Fl_Group(10, 60, 490, 145);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Choice* o = selHellFont = new Fl_Choice(20, 70, 150, 20, _("Transmit font"));
              ...
              { Fl_Check_Button* o = btnBlackboard = new Fl_Check_Button(305, 70, 125, 20, _("Reverse video"));
              ...
              { Fl_Spinner2* o = valHellXmtWidth = new Fl_Spinner2(20, 100, 40, 20, _("Transmit width"));
              ...
              { Fl_Check_Button* o = btnHellRcvWidth = new Fl_Check_Button(305, 100, 155, 20, _("Halve receive width"));
              ...
              { Fl_Choice* o = mnuHellPulse = new Fl_Choice(20, 147, 150, 20, _("Pulse shape"));
              ...
              { Fl_Value_Slider2* o = sldrHellBW = new Fl_Value_Slider2(211, 147, 246, 20, _("Receive filter bandwidth"));
              ...
              { Fl_Check_Button* o = btnFeldHellIdle = new Fl_Check_Button(20, 177, 230, 20, _("Transmit periods (.) when idle"));
              ...
              { Fl_Check_Button* o = btnHellXmtWidth = new Fl_Check_Button(310, 175, 113, 20, _("2x Xmt Width (hidden)"));
          ...
          { tabMT63 = new Fl_Group(5, 50, 500, 320, _("MT-63"));
            tabMT63->hide();
            { Fl_Group* o = new Fl_Group(10, 60, 490, 115);
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = btnmt63_interleave = new Fl_Check_Button(155, 78, 185, 20, _("64-bit (long) interleave"));
              ...
              { Fl_Check_Button* o = btnMT63_8bit = new Fl_Check_Button(155, 108, 205, 20, _("8-bit extended characters"));
              ...
              { Fl_Check_Button* o = btnMT63_rx_integration = new Fl_Check_Button(155, 138, 190, 20, _("Long receive integration"));
            ...
            { Fl_Group* o = new Fl_Group(11, 176, 490, 131);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Check_Button* o = btnMT63_usetones = new Fl_Check_Button(155, 184, 200, 20, _("Transmit lower start tone"));
              ...
              { Fl_Check_Button* o = btnMT63_upper_lower = new Fl_Check_Button(155, 214, 200, 20, _("Transmit upper start tone"));
              ...
              { Fl_Spinner2* o = MT63_tone_duration = new Fl_Spinner2(155, 240, 40, 20, _("Tone Duration (secs)"));
              ...
              { Fl_Check_Button* o = btnMT63_at500 = new Fl_Check_Button(155, 269, 200, 20, _("Allow manual tuning"));
          ...
          { tabOlivia = new Fl_Group(5, 50, 500, 320, _("Olivia"));
            tabOlivia->hide();
            { Fl_Group* o = new Fl_Group(10, 60, 490, 200);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Choice* o = mnuOlivia_Bandwidth = new Fl_Choice(65, 80, 85, 20, _("Bandwidth"));
              ...
              { Fl_Choice* o = mnuOlivia_Tones = new Fl_Choice(326, 80, 70, 20, _("Tones"));
              ...
              { Fl_Group* o = new Fl_Group(65, 119, 379, 100, _("Receive synchronizer"));
                o->box(FL_ENGRAVED_FRAME);
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
                { Fl_Counter2* o = cntOlivia_smargin = new Fl_Counter2(85, 150, 70, 20, _("Tune margin (tone frequency spacing)"));
                ...
                { Fl_Counter2* o = cntOlivia_sinteg = new Fl_Counter2(85, 180, 70, 20, _("Integration period (FEC blocks)"));
              ...
              { btnOlivia_8bit = new Fl_Check_Button(65, 229, 200, 20, _("8-bit extended characters"));
          ...
          { tabPSK = new Fl_Group(1, 50, 504, 340, _("PSK"));
            tabPSK->hide();
            { tabsPSK = new Fl_Tabs(1, 50, 504, 340);
              tabsPSK->selection_color(FL_LIGHT1);
              { Fl_Group* o = new Fl_Group(5, 75, 500, 295, _("General"));
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT));
                { Fl_Group* o = new Fl_Group(10, 85, 490, 98, _("AFC behavior"));
                o->box(FL_ENGRAVED_FRAME);
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
                { Fl_Counter2* o = cntSearchRange = new Fl_Counter2(20, 117, 75, 20, _("Acquisition search range (Hz)"));
                ...
                { Fl_Counter2* o = cntACQsn = new Fl_Counter2(20, 146, 75, 20, _("Acquisition S/N (dB)"));
                ...
                { Fl_Group* o = new Fl_Group(10, 183, 490, 65, _("S/N and IMD behavior"));
                o->box(FL_ENGRAVED_FRAME);
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
                { Fl_Choice* o = mnuPSKStatusTimeout = new Fl_Choice(20, 214, 80, 20, _("after"));
                ...
                { Fl_Counter2* o = new Fl_Counter2(161, 214, 75, 20, _("seconds"));
                ...
                { Fl_Group* o = new Fl_Group(11, 250, 490, 98, _("Multi-Channel Signal Processing"));
                o->box(FL_ENGRAVED_FRAME);
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
                { Fl_Check_Button* o = btnEnablePSKbrowsing = new Fl_Check_Button(21, 307, 180, 20, _("Multi-channel detector"));
                ...
                { Fl_Box* o = new Fl_Box(21, 277, 440, 20, _("Disable on very slow CPUs of if signal browser is not used"));
                o->align(Fl_Align(FL_ALIGN_LEFT|FL_ALIGN_INSIDE));
                } // Fl_Box* o
                o->end();
                } // Fl_Group* o
          ...
          { tabRTTY = new Fl_Group(5, 50, 500, 320, _("RTTY"));
            { Fl_Group* o = new Fl_Group(10, 60, 490, 300);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Choice* o = selShift = new Fl_Choice(20, 70, 100, 20, _("Carrier shift"));
              ...
              { Fl_Choice* o = selBaud = new Fl_Choice(20, 130, 100, 20, _("Baud rate"));
              ...
              { Fl_Choice* o = selBits = new Fl_Choice(20, 160, 100, 20, _("Bits per character"));
              ...
              { Fl_Choice* o = selParity = new Fl_Choice(20, 190, 100, 20, _("Parity"));
              ...
              { Fl_Choice* o = selStopBits = new Fl_Choice(20, 220, 100, 20, _("Stop bits"));
              ...
              { Fl_Group* o = new Fl_Group(264, 66, 230, 70);
                o->box(FL_ENGRAVED_FRAME);
                { Fl_Check_Button* o = btnAUTOCRLF = new Fl_Check_Button(274, 77, 90, 22, _("AutoCRLF"));
                ...
                { Fl_Check_Button* o = btnCRCRLF = new Fl_Check_Button(394, 77, 90, 22, _("CR-CR-LF"));
                ...
                { Fl_Counter2* o = cntrAUTOCRLF = new Fl_Counter2(344, 107, 65, 20, _("characters"));
                ...
                { Fl_Box* o = new Fl_Box(274, 107, 60, 20, _("after:"));
                o->align(Fl_Align(FL_ALIGN_LEFT|FL_ALIGN_INSIDE));
                } // Fl_Box* o
                o->end();
              } // Fl_Group* o
              { Fl_Group* o = new Fl_Group(264, 135, 231, 52, _("Unshift On Space"));
                o->box(FL_ENGRAVED_FRAME);
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
                { Fl_Check_Button* o = chkUOSrx = new Fl_Check_Button(313, 153, 63, 26, _("RX"));
                ...
                { Fl_Check_Button* o = chkUOStx = new Fl_Check_Button(403, 153, 63, 26, _("TX"));
              ...
              { Fl_Group* o = new Fl_Group(264, 187, 231, 52, _("Log RTTY frequency"));
                o->box(FL_ENGRAVED_FRAME);
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
                { Fl_Check_Button* o = chk_useMARKfreq = new Fl_Check_Button(274, 205, 63, 26, _("Use MARK freq\'"));
                ...
                { Fl_Button* o = btnRTTY_mark_color = new Fl_Button(408, 208, 18, 18, _("track clr"));
              ...
              { Fl_Check_Button* o = btnPreferXhairScope = new Fl_Check_Button(20, 254, 165, 20, _("Use cross hair scope"));
              ...
              { Fl_Check_Button* o = chkPseudoFSK = new Fl_Check_Button(20, 284, 270, 20, _("Pseudo-FSK on right audio channel"));
              ...
              { Fl_Choice* o = mnuRTTYAFCSpeed = new Fl_Choice(313, 254, 80, 20, _("AFC speed"));
              ...
              { Fl_Check_Button* o = chkXagc = new Fl_Check_Button(313, 284, 62, 22, _("X-agc (hidden)"));
                chkXagc->down_box(FL_DOWN_BOX);
                chkXagc->callback((Fl_Callback*)cb_chkXagc);
                o->value(progdefaults.Xagc);
                o->hide();
              } // Fl_Check_Button* chkXagc
              { Fl_Value_Slider2* o = sldrRTTYbandwidth = new Fl_Value_Slider2(105, 325, 300, 20, _("Receive filter bandwidth"));
              ...
              { Fl_Counter2* o = selCustomShift = new Fl_Counter2(20, 100, 100, 20, _("Custom shift"));
          ...
          { tabTHOR = new Fl_Group(5, 50, 500, 320, _("Thor"));
            tabTHOR->hide();
            { Fl_Group* o = new Fl_Group(10, 60, 490, 170);
              o->box(FL_ENGRAVED_FRAME);
              { txtTHORSecondary = new Fl_Input2(20, 87, 360, 40, _("Secondary Text"));
              ...
              { Fl_Check_Button* o = valTHOR_FILTER = new Fl_Check_Button(20, 141, 80, 20, _("Filtering"));
              ...
              { Fl_Counter2* o = valTHOR_BW = new Fl_Counter2(161, 141, 63, 20, _("Filter bandwidth factor"));
              ...
              { Fl_Value_Slider2* o = valThorCWI = new Fl_Value_Slider2(20, 194, 260, 20, _("CWI threshold"));
              ...
              { Fl_Counter2* o = valTHOR_PATHS = new Fl_Counter2(358, 193, 75, 21, _("Paths (hidden)"));
          ...
          { tabPacket = new Fl_Group(5, 50, 500, 320, _("Packet"));
            tabPacket->hide();
            { Fl_Group* o = new Fl_Group(10, 60, 490, 296);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Choice* o = selPacket_Baud = new Fl_Choice(49, 85, 100, 20, _("Baud rate"));
              ...
              { Fl_Counter2* o = valPacket_LoSig_RXGain = new Fl_Counter2(47, 148, 63, 20, _("RX Low Freq Gain"));
              ...
              { Fl_Counter2* o = valPacket_HiSig_RXGain = new Fl_Counter2(47, 173, 63, 20, _("RX High Freq Gain"));
              ...
              { Fl_Counter2* o = valPacket_LoSig_TXGain = new Fl_Counter2(273, 148, 63, 20, _("TX Low Freq Gain"));
              ...
              { Fl_Counter2* o = valPacket_HiSig_TXGain = new Fl_Counter2(273, 173, 63, 20, _("TX High Freq Gain"));
              ...
              { Fl_Check_Button* o = btnPktRXTimestamp = new Fl_Check_Button(44, 208, 165, 20, _("add RX timestamps"));
              ...
              { Fl_Check_Button* o = btnPktexpandCmp = new Fl_Check_Button(273, 208, 190, 20, _("decode Compressed data"));
              ...
              { Fl_Check_Button* o = btnPktexpandMicE = new Fl_Check_Button(44, 234, 165, 20, _("decode Mic-E data"));
              ...
              { Fl_Check_Button* o = btnPktexpandPHG = new Fl_Check_Button(44, 261, 165, 20, _("decode PHG data"));
              ...
              { Fl_Check_Button* o = btnPktunitsSI = new Fl_Check_Button(44, 288, 165, 20, _("use SI units"));
              ...
              { Fl_Check_Button* o = btnPktunitsEnglish = new Fl_Check_Button(44, 315, 165, 20, _("use English units"));
              ...
              { Fl_Check_Button* o = btnPktPreferXhairScope = new Fl_Check_Button(273, 234, 165, 20, _("Use cross-hair scope"));
              ...
              { Fl_Check_Button* o = btnPktAudioBoost = new Fl_Check_Button(50, 115, 165, 20, _("boost Audio input"));
      ...
      { tabRig = new Fl_Group(5, 25, 500, 345, _("Rig"));
        tabRig->tooltip(_("Transceiver control"));
        tabRig->hide();
        { tabsRig = new Fl_Tabs(5, 25, 500, 345);
          tabsRig->selection_color(FL_LIGHT1);
          { Fl_Group* o = new Fl_Group(5, 50, 500, 320, _("Hardware PTT"));
            { grpHWPTT = new Fl_Group(10, 100, 490, 265, _("h/w ptt device-pin"));
              grpHWPTT->box(FL_ENGRAVED_FRAME);
              grpHWPTT->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { inpTTYdev = new Fl_Input_Choice(205, 209, 160, 22, _("Device:"));
                inpTTYdev->tooltip(_("Select serial port"));
                inpTTYdev->callback((Fl_Callback*)cb_inpTTYdev);
              } // Fl_Input_Choice* inpTTYdev
              { btnRTSptt = new Fl_Round_Button(150, 248, 85, 20, _("Use RTS"));
              ...
              { btnRTSplusV = new Fl_Round_Button(267, 248, 100, 20, _("RTS = +V"));
              ...
              { btnDTRptt = new Fl_Round_Button(150, 278, 85, 20, _("Use DTR"));
              ...
              { btnDTRplusV = new Fl_Round_Button(267, 278, 100, 20, _("DTR = +V"));
              ...
              { btnInitHWPTT = new Fl_Button(193, 316, 113, 24, _("Initialize"));
              ...
              { btnTTYptt = new Fl_Round_Button(150, 110, 220, 20, _("Use separate serial port PTT"));
              ...
              { btnUsePPortPTT = new Fl_Round_Button(150, 140, 170, 20, _("Use parallel port PTT"));
              ...
              { btnUseUHrouterPTT = new Fl_Round_Button(150, 170, 170, 20, _("Use uHRouter PTT"));
            ...
            { Fl_Group* o = new Fl_Group(10, 60, 490, 38);
              o->box(FL_ENGRAVED_FRAME);
              { Fl_Check_Button* o = btnPTTrightchannel = new Fl_Check_Button(135, 69, 250, 20, _("PTT tone on right audio channel "));
          ...
          { Fl_Group* o = new Fl_Group(5, 50, 500, 320, _("RigCAT"));
            o->tooltip(_("Rig Control using xml spec file"));
            o->hide();
            { chkUSERIGCAT = new Fl_Check_Button(200, 60, 110, 20, _("Use RigCAT"));
            ...
            { grpRigCAT = new Fl_Group(10, 83, 490, 279);
              grpRigCAT->box(FL_ENGRAVED_FRAME);
              { Fl_Output* o = txtXmlRigFilename = new Fl_Output(20, 107, 130, 22, _("Rig description file:"));
              ...
              { btnSelectRigXmlFile = new Fl_Button(153, 107, 60, 22, _("Open..."));
              ...
              { Fl_Input_Choice* o = inpXmlRigDevice = new Fl_Input_Choice(346, 107, 144, 22, _("Device:"));
              ...
              { Fl_Value_Input2* o = cntRigCatRetries = new Fl_Value_Input2(35, 150, 60, 22, _("Retries"));
              ...
              { Fl_Value_Input2* o = cntRigCatTimeout = new Fl_Value_Input2(153, 150, 60, 22, _("Retry interval (ms)"));
              ...
              { Fl_Value_Input2* o = cntRigCatWait = new Fl_Value_Input2(35, 190, 60, 22, _("Write delay (ms)"));
              ...
              { Fl_Choice* o = mnuXmlRigBaudrate = new Fl_Choice(391, 150, 99, 22, _("Baud rate:"));
              ...
              { Fl_Counter2* o = valRigCatStopbits = new Fl_Counter2(393, 184, 95, 21, _("Stopbits"));
              ...
              { btnInitRIGCAT = new Fl_Button(370, 321, 113, 24, _("Initialize"));
              ...
              { Fl_Check_Button* o = btnRigCatEcho = new Fl_Check_Button(55, 216, 192, 22, _("Commands are echoed"));
              ...
              { Fl_Round_Button* o = btnRigCatCMDptt = new Fl_Round_Button(261, 217, 207, 20, _("CAT command for PTT"));
              ...
              { Fl_Round_Button* o = btnRigCatRTSptt = new Fl_Round_Button(55, 250, 160, 20, _("Toggle RTS for PTT"));
              ...
              { Fl_Round_Button* o = btnRigCatDTRptt = new Fl_Round_Button(261, 250, 160, 20, _("Toggle DTR for PTT"));
              ...
              { Fl_Check_Button* o = btnRigCatRTSplus = new Fl_Check_Button(55, 285, 100, 20, _("RTS +12 v"));
              ...
              { Fl_Check_Button* o = btnRigCatDTRplus = new Fl_Check_Button(261, 285, 100, 20, _("DTR +12 v"));
              ...
              { Fl_Check_Button* o = chkRigCatRTSCTSflow = new Fl_Check_Button(55, 320, 170, 20, _("RTS/CTS flow control"));
              ...
              { btnRevertRIGCAT = new Fl_Button(370, 289, 113, 24, _("Revert"));
              ...
              { Fl_Check_Button* o = chkRigCatVSP = new Fl_Check_Button(261, 315, 100, 25, _("VSP Enable"));
          ...
          { tabHamlib = new Fl_Group(5, 50, 500, 320, _("Hamlib"));
            tabHamlib->hide();
            { chkUSEHAMLIB = new Fl_Check_Button(200, 60, 100, 20, _("Use Hamlib"));
            ...
            { grpHamlib = new Fl_Group(10, 83, 490, 277);
              grpHamlib->box(FL_ENGRAVED_FRAME);
              { Fl_ComboBox* o = cboHamlibRig = new Fl_ComboBox(70, 93, 160, 22, _("Rig:"));
              ...
              { Fl_Input_Choice* o = inpRIGdev = new Fl_Input_Choice(345, 93, 144, 22, _("Device:"));
              ...
              { Fl_Value_Input2* o = cntHamlibRetries = new Fl_Value_Input2(35, 133, 70, 24, _("Retries"));
              ...
              { Fl_Value_Input2* o = cntHamlibTimeout = new Fl_Value_Input2(160, 133, 70, 24, _("Retry Interval (ms)"));
              ...
              { Fl_Value_Input2* o = cntHamlibWriteDelay = new Fl_Value_Input2(35, 176, 70, 24, _("Write delay (ms)"));
              ...
              { Fl_Value_Input2* o = cntHamlibWait = new Fl_Value_Input2(161, 176, 70, 24, _("Post write delay (ms)"));
              ...
              { Fl_Choice* o = mnuBaudRate = new Fl_Choice(390, 127, 99, 22, _("Baud rate:"));
              ...
              { Fl_Counter2* o = valHamRigStopbits = new Fl_Counter2(394, 163, 95, 21, _("Stopbits"));
              ...
              { Fl_Counter2* o = cntHamlibTimeout0 = new Fl_Counter2(155, 140, 100, 20, _("Retry interval (ms)"));
              ...
              { inpHamlibConfig = new Fl_Input2(25, 326, 320, 22, _("Advanced configuration:"));
              ...
              { btnInitHAMLIB = new Fl_Button(376, 325, 113, 24, _("Initialize"));
              ...
              { mnuSideband = new Fl_Choice(345, 217, 144, 22, _("Sideband:"));
              ...
              { Fl_Round_Button* o = btnHamlibCMDptt = new Fl_Round_Button(50, 218, 200, 20, _("PTT via Hamlib command"));
              ...
              { Fl_Check_Button* o = btnHamlibDTRplus = new Fl_Check_Button(50, 243, 90, 20, _("DTR +12"));
              ...
              { Fl_Check_Button* o = chkHamlibRTSplus = new Fl_Check_Button(274, 243, 85, 20, _("RTS +12"));
              ...
              { Fl_Check_Button* o = chkHamlibRTSCTSflow = new Fl_Check_Button(50, 271, 170, 20, _("RTS/CTS flow control"));
              ...
              { Fl_Check_Button* o = chkHamlibXONXOFFflow = new Fl_Check_Button(274, 271, 185, 20, _("XON/XOFF flow control"));
              ...
              { btnRevertHAMLIB = new Fl_Button(376, 294, 113, 24, _("Revert"));
          ...
          { Fl_Group* o = new Fl_Group(5, 50, 500, 320, _("MemMap"));
            o->hide();
            { grpMemmap = new Fl_Group(10, 60, 490, 185);
              grpMemmap->box(FL_ENGRAVED_FRAME);
              { Fl_Output* o = new Fl_Output(165, 79, 190, 58);
                o->type(12);
                o->box(FL_BORDER_BOX);
                o->color(FL_LIGHT1);
                o->value(_("Control via Memory Mapped\nshared variables\ni.e.: Kachina program"));
              } // Fl_Output* o
              { Fl_Check_Button* o = chkUSEMEMMAP = new Fl_Check_Button(165, 147, 120, 20, _("Use Memmap"));
              ...
              { btnMEMMAPptt = new Fl_Round_Button(165, 177, 150, 20, _("Use Memmap PTT"));
              ...
              { btnInitMEMMAP = new Fl_Button(202, 207, 113, 24, _("Initialize"));
          ...
          { tabXMLRPC = new Fl_Group(5, 50, 500, 320, _("XML-RPC"));
            tabXMLRPC->hide();
            { grpXMLRPC = new Fl_Group(10, 60, 490, 160);
              ...
              { chkUSEXMLRPC = new Fl_Check_Button(165, 147, 183, 20, _("Use XML-RPC program"));
              ...
              { btnInitXMLRPC = new Fl_Button(206, 183, 113, 24, _("Initialize"));
      ...
      { tabSoundCard = new Fl_Group(0, 25, 505, 405, _("Audio"));
        ...
        { tabsSoundCard = new Fl_Tabs(0, 25, 505, 405);
          ...
          { tabAudio = new Fl_Group(5, 50, 500, 380, _("Devices"));
            ...
            { AudioOSS = new Fl_Group(10, 60, 490, 85);
              ...
              { Fl_Input_Choice* o = menuOSSDev = new Fl_Input_Choice(380, 70, 110, 25, _("Rig Device:"));
              ...
              { Fl_Input_Choice* o = menuVoiceOSSDev = new Fl_Input_Choice(380, 105, 110, 25, _("Voice Device:"));
                menuVoiceOSSDev->tooltip(_("Select device"));
                menuVoiceOSSDev->callback((Fl_Callback*)cb_menuVoiceOSSDev);
                o->value(progdefaults.voiceOSSdevice.c_str());
              } // Fl_Input_Choice* menuVoiceOSSDev
              AudioOSS->end();
            } // Fl_Group* AudioOSS
            { AudioPort = new Fl_Group(10, 145, 490, 150);
              AudioPort->box(FL_ENGRAVED_FRAME);
              { btnAudioIO[1] = new Fl_Round_Button(20, 155, 95, 25, _("PortAudio"));
              ...
              { menuPortInDev = new Fl_Choice(220, 155, 270, 25, _("Rig capture:"));
              ...
              { menuPortOutDev = new Fl_Choice(220, 190, 270, 25, _("Rig playback:"));
              ...
              { menuVoicePortInDev = new Fl_Choice(220, 225, 270, 25, _("Voice capture:"));
                menuVoicePortInDev->tooltip(_("Audio input device"));
                menuVoicePortInDev->down_box(FL_BORDER_BOX);
                menuVoicePortInDev->callback((Fl_Callback*)cb_menuVoicePortInDev);
              } // Fl_Choice* menuVoicePortInDev
              { menuVoicePortOutDev = new Fl_Choice(220, 260, 270, 25, _("Voice playback:"));
                menuVoicePortOutDev->tooltip(_("Audio output device"));
                menuVoicePortOutDev->down_box(FL_BORDER_BOX);
                menuVoicePortOutDev->callback((Fl_Callback*)cb_menuVoicePortOutDev);
              } // Fl_Choice* menuVoicePortOutDev
              AudioPort->end();
            } // Fl_Group* AudioPort
            { AudioPulse = new Fl_Group(10, 295, 490, 80);
              AudioPulse->box(FL_ENGRAVED_FRAME);
              { btnAudioIO[2] = new Fl_Round_Button(20, 306, 100, 25, _("PulseAudio"));
              ...
              { Fl_Input2* o = inpPulseServer = new Fl_Input2(265, 306, 225, 25, _("Rig server string:"));
              ...
              { Fl_Input2* o = inpVoicePulseServer = new Fl_Input2(265, 340, 225, 25, _("Voice server string:"));
                inpVoicePulseServer->tooltip(_("Leave this blank or refer to\nhttp://www.pulseaudio.org/wiki/ServerStrings"));
                inpVoicePulseServer->box(FL_DOWN_BOX);
                inpVoicePulseServer->color(FL_BACKGROUND2_COLOR);
                inpVoicePulseServer->selection_color(FL_SELECTION_COLOR);
                inpVoicePulseServer->labeltype(FL_NORMAL_LABEL);
                inpVoicePulseServer->labelfont(0);
                inpVoicePulseServer->labelsize(14);
                inpVoicePulseServer->labelcolor(FL_FOREGROUND_COLOR);
                inpVoicePulseServer->callback((Fl_Callback*)cb_inpVoicePulseServer);
                inpVoicePulseServer->align(Fl_Align(FL_ALIGN_LEFT));
                inpVoicePulseServer->when(FL_WHEN_RELEASE);
                o->value(progdefaults.VoicePulseServer.c_str());
                inpVoicePulseServer->labelsize(FL_NORMAL_SIZE);
          ...
          { tabAudioOpt = new Fl_Group(0, 55, 505, 330, _("Settings"));
            tabAudioOpt->hide();
            { grpAudioSampleRate = new Fl_Group(15, 75, 490, 150, _("Sample rate"));
              grpAudioSampleRate->box(FL_ENGRAVED_FRAME);
              grpAudioSampleRate->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Choice* o = menuInSampleRate = new Fl_Choice(25, 104, 100, 20, _("Rig Capture"));
...
ll with your audio device."));
              ...
              { Fl_Choice* o = menuOutSampleRate = new Fl_Choice(25, 134, 100, 20, _("Rig Playback"));
              ...
              { menuSampleConverter = new Fl_Choice(279, 104, 216, 20, _("Converter"));
              ...
              { Fl_Choice* o = menuVoiceInSampleRate = new Fl_Choice(25, 165, 100, 20, _("Voice Capture"));
                menuVoiceInSampleRate->tooltip(_("Force a specific sample rate. Select \"Native\" if \"Auto\"\ndoes not work we\
ll with your audio device."));
                menuVoiceInSampleRate->down_box(FL_BORDER_BOX);
                menuVoiceInSampleRate->callback((Fl_Callback*)cb_menuVoiceInSampleRate);
                menuVoiceInSampleRate->align(Fl_Align(FL_ALIGN_RIGHT));
                //extern Fl_Menu_Item sample_rate_menu[];
                //o->menu(sample_rate_menu);
                o->clear_changed();
              } // Fl_Choice* menuVoiceInSampleRate
              { Fl_Choice* o = menuVoiceOutSampleRate = new Fl_Choice(25, 195, 100, 20, _("Voice Playback"));
                menuVoiceOutSampleRate->down_box(FL_BORDER_BOX);
                menuVoiceOutSampleRate->callback((Fl_Callback*)cb_menuVoiceOutSampleRate);
                menuVoiceOutSampleRate->align(Fl_Align(FL_ALIGN_RIGHT));
                //extern Fl_Menu_Item sample_rate_menu[];
                //o->menu(sample_rate_menu);
                o->clear_changed();
                o->tooltip(menuVoiceInSampleRate->tooltip());
              } // Fl_Choice* menuVoiceOutSampleRate
              grpAudioSampleRate->end();
            } // Fl_Group* grpAudioSampleRate
            { Fl_Group* o = new Fl_Group(15, 228, 490, 62, _("Corrections"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Spinner2* o = cntRxRateCorr = new Fl_Spinner2(25, 258, 85, 20, _("RX ppm"));
              ...
              { Fl_Spinner2* o = cntTxRateCorr = new Fl_Spinner2(186, 258, 85, 20, _("TX ppm"));
              ...
              { Fl_Spinner2* o = cntTxOffset = new Fl_Spinner2(348, 258, 85, 20, _("TX offset"));
            ...
            { chkAudioStereoOut = new Fl_Check_Button(25, 300, 220, 20, _("Enable right audio channel"));
          ...
          { tabMixer = new Fl_Group(10, 55, 495, 330, _("Mixer"));
            tabMixer->hide();
            { Fl_Group* o = new Fl_Group(15, 60, 490, 145, _("OSS mixer"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = btnMixer = new Fl_Check_Button(25, 89, 125, 25, _("Manage mixers"));
              ...
              { Fl_Input_Choice* o = menuMix = new Fl_Input_Choice(171, 132, 110, 25, _("Device:"));
              ...
              { Fl_Value_Slider2* o = valPCMvolume = new Fl_Value_Slider2(25, 167, 340, 20, _("PCM"));
          ...
          { tabTxLevel = new Fl_Group(5, 55, 500, 320, _("TxLevel"));
            tabTxLevel->hide();
            { Fl_Group* o = new Fl_Group(15, 65, 490, 86, _("Tx Attenuator"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Counter* o = valTxLevel = new Fl_Counter(206, 90, 120, 21, _("Tx Atten (dB)"));
      ...
      { tabID = new Fl_Group(5, 25, 500, 346, _("ID"));
        tabID->hide();
        { Fl_Group* o = new Fl_Group(10, 35, 490, 103, _("Video Preamble ID"));
          o->box(FL_ENGRAVED_FRAME);
          o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
          { btnsendid = new Fl_Check_Button(20, 58, 150, 20, _("Transmit mode ID"));
          ...
          { Fl_Check_Button* o = btnsendvideotext = new Fl_Check_Button(20, 83, 155, 20, _("Transmit video text"));
          ...
          { Fl_Input2* o = valVideotext = new Fl_Input2(187, 83, 161, 20, _(":"));
          ...
          { Fl_Check_Button* o = chkID_SMALL = new Fl_Check_Button(20, 109, 120, 20, _("Use small font"));
          ...
          { Fl_Value_Slider2* o = sldrVideowidth = new Fl_Value_Slider2(248, 109, 100, 20, _("Chars/Row:"));
          ...
          { Fl_Check_Button* o = btn_vidlimit = new Fl_Check_Button(357, 85, 110, 15, _("500 Hz limit"));
          ...
          { Fl_Check_Button* o = btn_vidmodelimit = new Fl_Check_Button(357, 111, 110, 15, _("Mode width limit"));
          ...
          { bVideoIDModes = new Fl_Button(228, 58, 120, 20, _("Video ID modes"));
            bVideoIDModes->callback((Fl_Callback*)cb_bVideoIDModes);
          } // Fl_Button* bVideoIDModes
          o->end();
        } // Fl_Group* o
        { sld = new Fl_Group(10, 138, 490, 60, _("CW Postamble ID"));
          sld->box(FL_ENGRAVED_FRAME);
          sld->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
          { Fl_Check_Button* o = btnCWID = new Fl_Check_Button(20, 165, 140, 20, _("Transmit callsign"));
          ...
          { Fl_Value_Slider2* o = sldrCWIDwpm = new Fl_Value_Slider2(170, 165, 180, 20, _("Speed (WPM):"));
          ...
          { bCWIDModes = new Fl_Button(370, 165, 120, 20, _("CW ID modes"));
            bCWIDModes->callback((Fl_Callback*)cb_bCWIDModes);
          } // Fl_Button* bCWIDModes
          sld->end();
        } // Fl_Group* sld
        { Fl_Group* o = new Fl_Group(10, 198, 295, 167, _("Reed-Solomon ID (Rx)"));
          o->box(FL_ENGRAVED_FRAME);
          o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
          { Fl_Check_Button* o = chkRSidWideSearch = new Fl_Check_Button(20, 247, 270, 20, _("Detector searches entire passband"));
          ...
          { chkRSidMark = new Fl_Check_Button(20, 270, 270, 20, _("Mark previous frequency and mode"));
          ...
          { chkRSidAutoDisable = new Fl_Check_Button(20, 293, 200, 20, _("Reception disables detector"));
          ...
          { chkRSidNotifyOnly = new Fl_Check_Button(20, 317, 155, 20, _("Notifications only"));
...
d frequency"));
          ...
          { bRSIDRxModes = new Fl_Button(20, 224, 130, 20, _("Receive modes"));
            bRSIDRxModes->callback((Fl_Callback*)cb_bRSIDRxModes);
          } // Fl_Button* bRSIDRxModes
          { Fl_Value_Slider2* o = sldrRSIDsquelch = new Fl_Value_Slider2(20, 339, 144, 20, _("Squelch open (sec)"));
        ...
        { Fl_Group* o = new Fl_Group(305, 198, 195, 85, _("Reed-Solomon ID (Tx)"));
          o->box(FL_ENGRAVED_FRAME);
          o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
          { bRSIDTxModes = new Fl_Button(333, 233, 130, 20, _("Transmit modes"));
            bRSIDTxModes->callback((Fl_Callback*)cb_bRSIDTxModes);
          } // Fl_Button* bRSIDTxModes
          o->end();
        } // Fl_Group* o
        { Fl_Group* o = new Fl_Group(305, 284, 195, 80, _("Pre-Signal Tone"));
          o->box(FL_ENGRAVED_FRAME);
          o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
          { Fl_Counter* o = val_pretone = new Fl_Counter(328, 310, 140, 21, _("Seconds"));
      ...
      { tabMisc = new Fl_Group(5, 25, 500, 345, _("Misc"));
        tabMisc->hide();
        { tabsMisc = new Fl_Tabs(5, 25, 500, 345);
          tabsMisc->selection_color(FL_LIGHT1);
          { tabCPUspeed = new Fl_Group(5, 50, 500, 320, _("CPU"));
            { Fl_Group* o = new Fl_Group(10, 60, 490, 51);
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = chkSlowCpu = new Fl_Check_Button(156, 75, 225, 20, _("Slow CPU (less than 700MHz)"));
          ...
          { tabNBEMS = new Fl_Group(5, 50, 500, 320, _("NBEMS"));
            tabNBEMS->hide();
            { Fl_Group* o = new Fl_Group(10, 60, 490, 75, _("NBEMS data file interface"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = chkAutoExtract = new Fl_Check_Button(30, 95, 75, 20, _("Enable"));
              ...
              { Fl_Check_Button* o = chk_open_wrap_folder = new Fl_Check_Button(264, 95, 146, 20, _("Open message folder"));
            ...
            { Fl_Group* o = new Fl_Group(10, 136, 490, 95, _("Reception of flmsg file"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = chk_open_flmsg = new Fl_Check_Button(30, 163, 136, 20, _("Open with flmsg"));
              ...
              { Fl_Input2* o = txt_flmsg_pathname = new Fl_Input2(62, 194, 330, 24, _("flmsg:"));
              ...
              { btn_select_flmsg = new Fl_Button(395, 194, 100, 24, _("Locate flmsg"));
              ...
              { Fl_Check_Button* o = chk_open_flmsg_print = new Fl_Check_Button(264, 163, 136, 20, _("Open in browser"));
          ...
          { tabPskmail = new Fl_Group(5, 50, 500, 320, _("Pskmail"));
            tabPskmail->align(Fl_Align(FL_ALIGN_TOP_LEFT));
            tabPskmail->hide();
            { Fl_Group* o = new Fl_Group(10, 58, 490, 174, _("Mail Server Attributes"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Counter2* o = cntServerCarrier = new Fl_Counter2(61, 86, 80, 20, _("Carrier frequency (Hz)"));
              ...
              { Fl_Counter2* o = cntServerOffset = new Fl_Counter2(61, 123, 80, 20, _("Search range (Hz)"));
              ...
              { Fl_Counter2* o = cntServerACQsn = new Fl_Counter2(61, 160, 80, 20, _("Acquisition S/N (dB)"));
              ...
              { Fl_Counter2* o = cntServerAFCrange = new Fl_Counter2(61, 197, 80, 20, _("AFC range (Hz)"));
              ...
              { Fl_Check_Button* o = btnPSKmailSweetSpot = new Fl_Check_Button(316, 86, 142, 20, _("Reset to Carrier"));
            ...
            { Fl_Group* o = new Fl_Group(10, 234, 490, 131, _("General"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = btn_arq_s2n_report = new Fl_Check_Button(35, 259, 250, 20, _("Report ARQ frames average S/N"));
          ...
          { tabSpot = new Fl_Group(5, 50, 500, 320, _("Spotting"));
            tabSpot->hide();
            { Fl_Group* o = new Fl_Group(10, 60, 490, 215, _("PSK Reporter"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { btnPSKRepAuto = new Fl_Check_Button(20, 91, 324, 20, _("Automatically spot callsigns in decoded text"));
              ...
              { btnPSKRepLog = new Fl_Check_Button(20, 121, 327, 20, _("Send reception report when logging a QSO"));
              ...
              { btnPSKRepQRG = new Fl_Check_Button(20, 151, 416, 20, _("Report rig frequency (enable only if you have rig control!)"));
              ...
              { inpPSKRepHost = new Fl_Input2(61, 191, 220, 24, _("Host:"));
              ...
              { inpPSKRepPort = new Fl_Input2(430, 191, 60, 24, _("Port:"));
              ...
              { btnPSKRepInit = new Fl_Button(410, 236, 80, 24, _("Initialize"));
              ...
              { boxPSKRepMsg = new Fl_Box(20, 220, 300, 48, _("<PSK Reporter error message>"));
          ...
          { tabSweetSpot = new Fl_Group(5, 50, 500, 320, _("Sweet Spot"));
            tabSweetSpot->hide();
            { Fl_Group* o = new Fl_Group(10, 60, 490, 75);
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Value_Input2* o = valCWsweetspot = new Fl_Value_Input2(47, 71, 65, 20, _("CW"));
              ...
              { Fl_Value_Input2* o = valRTTYsweetspot = new Fl_Value_Input2(225, 71, 65, 20, _("RTTY"));
              ...
              { Fl_Value_Input2* o = valPSKsweetspot = new Fl_Value_Input2(425, 71, 65, 20, _("PSK et al."));
              ...
              { Fl_Check_Button* o = btnStartAtSweetSpot = new Fl_Check_Button(20, 101, 348, 20, _("Always start new modems at these frequencies"));
            ...
            { Fl_Group* o = new Fl_Group(10, 140, 490, 60, _("A1A offset configuration"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = btnCWIsLSB = new Fl_Check_Button(360, 165, 70, 15, _("CW is LSB"));
              ...
              { Fl_Check_Button* o = btnCWOffset = new Fl_Check_Button(35, 165, 70, 15, _("Display true frequency in the waterfall"));
 ...
 in CW (A1A) mode"));
          ...
          { tabText_IO = new Fl_Group(5, 50, 500, 320, _("Text i/o"));
            tabText_IO->hide();
            { grpTalker = new Fl_Group(10, 117, 490, 73, _("Talker Socket (MS only)"));
              grpTalker->box(FL_ENGRAVED_FRAME);
              grpTalker->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { btnConnectTalker = new Fl_Light_Button(36, 137, 74, 20, _("Talker"));
              ...
              { Fl_Box* o = new Fl_Box(115, 137, 345, 20, _("Connect/disconnect to Talker socket server"));
                o->align(Fl_Align(FL_ALIGN_LEFT|FL_ALIGN_INSIDE));
              } // Fl_Box* o
              { Fl_Check_Button* o = btn_auto_talk = new Fl_Check_Button(36, 165, 391, 15, _("Auto connect when fldigi opens (server must be up)"));
            ...
            { Fl_Group* o = new Fl_Group(10, 57, 490, 56, _("Capture rx text to external file"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = chkRxStream = new Fl_Check_Button(36, 84, 175, 20, _("Enable rx text stream"));
          ...
          { tabDTMFdecode = new Fl_Group(5, 50, 500, 320, _("DTMF"));
            tabDTMFdecode->hide();
            { Fl_Check_Button* o = chkDTMFdecode = new Fl_Check_Button(170, 85, 175, 20, _("Decode DTMF tones"));
      ...
      { tabQRZ = new Fl_Group(5, 25, 500, 345, _("Web"));
        tabQRZ->tooltip(_("Callsign database"));
        tabQRZ->hide();
        { Fl_Tabs* o = new Fl_Tabs(5, 25, 500, 345);
          { Fl_Group* o = new Fl_Group(5, 46, 500, 324, _("QRZ/etal"));
            { Fl_Group* o = new Fl_Group(10, 55, 490, 120);
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Round_Button* o = btnQRZnotavailable = new Fl_Round_Button(30, 64, 337, 20, _("Not available"));
              ...
              { Fl_Round_Button* o = btnQRZonline = new Fl_Round_Button(30, 92, 337, 20, _("QRZ online via default Internet Browser"));
              ...
              { Fl_Round_Button* o = btnHAMCALLonline = new Fl_Round_Button(30, 120, 337, 20, _("HamCall online via default Internet Browser"));
              ...
              { Fl_Round_Button* o = btnCALLOOK = new Fl_Round_Button(30, 148, 337, 20, _("Callook.info lookup (US callsigns only)"));
            ...
            { Fl_Group* o = new Fl_Group(10, 176, 490, 55, _("CDROM"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Round_Button* o = btnQRZcdrom = new Fl_Round_Button(30, 196, 70, 20, _("QRZ"));
              ...
              { Fl_Input2* o = txtQRZpathname = new Fl_Input2(109, 196, 300, 20, _("at:"));
            ...
            { Fl_Group* o = new Fl_Group(10, 232, 490, 134, _("Subscriber data"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Round_Button* o = btnQRZsub = new Fl_Round_Button(30, 263, 90, 20, _("QRZ.com"));
              ...
              { Fl_Round_Button* o = btnHamcall = new Fl_Round_Button(30, 297, 105, 20, _("Hamcall.net"));
              ...
              { Fl_Input2* o = inpQRZusername = new Fl_Input2(240, 263, 150, 20, _("User name"));
              ...
              { Fl_Input2* o = inpQRZuserpassword = new Fl_Input2(240, 297, 150, 20, _("Password"));
              ...
              { btnQRZpasswordShow = new Fl_Button(400, 297, 70, 20, _("Show"));
              ...
              { Fl_Round_Button* o = btnHamQTH = new Fl_Round_Button(31, 332, 121, 20, _("HamQTH.com (free service http://www.hamqth.com)"));
          ...
          { Fl_Group* o = new Fl_Group(5, 50, 500, 320, _("eQSL"));
            o->hide();
            { Fl_Input2* o = inpEQSL_id = new Fl_Input2(181, 75, 150, 20, _("User ID"));
            ...
            { Fl_Input2* o = inpEQSL_pwd = new Fl_Input2(181, 106, 150, 20, _("Password"));
            ...
            { btnEQSL_pwd_show = new Fl_Button(349, 106, 70, 20, _("Show"));
            ...
            { Fl_Input2* o = inpEQSL_nick = new Fl_Input2(181, 137, 150, 20, _("QTH Nickname"));
            ...
            { Fl_Group* o = new Fl_Group(9, 170, 492, 194, _("Options"));
              o->box(FL_ENGRAVED_FRAME);
              o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
              { Fl_Check_Button* o = btn_send_when_logged = new Fl_Check_Button(34, 191, 70, 15, _("send when logged (log button, <LOG>, <LNW>)"));
              ...
              { Fl_Input2* o = txt_eqsl_default_message = new Fl_Input2(38, 226, 451, 40, _("Default message"));
              ...
              { Fl_Group* o = new Fl_Group(13, 270, 484, 90, _("Text Tags (tags use {} delimiters)"));
                o->box(FL_THIN_DOWN_BOX);
                o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
                { eqsl_txt1 = new Fl_Box(19, 317, 220, 17, _("{CALL} other ops call sign"));
                eqsl_txt1->align(Fl_Align(FL_ALIGN_LEFT|FL_ALIGN_INSIDE));
                } // Fl_Box* eqsl_txt1
                { eqsl_txt2 = new Fl_Box(17, 336, 220, 17, _("{MODE} full mode / submode"));
                eqsl_txt2->align(Fl_Align(FL_ALIGN_LEFT|FL_ALIGN_INSIDE));
                } // Fl_Box* eqsl_txt2
                { eqsl_txt3 = new Fl_Box(265, 317, 220, 17, _("{NAME} other ops name"));
                eqsl_txt3->align(Fl_Align(FL_ALIGN_LEFT|FL_ALIGN_INSIDE));
                } // Fl_Box* eqsl_txt3
                { new Fl_Box(33, 293, 440, 17, _("These tags can also be used in <EQSL:[message]>"));
                } // Fl_Box* o
                o->end();
              } // Fl_Group* o
              o->end();
    ...
    { btnSaveConfig = new Fl_Button(235, 432, 130, 22, _("Save"));
      btnSaveConfig->callback((Fl_Callback*)cb_btnSaveConfig);
    } // Fl_Button* btnSaveConfig
    { btnCloseConfig = new Fl_Return_Button(367, 432, 130, 22, _("Close"));
      btnCloseConfig->callback((Fl_Callback*)cb_btnCloseConfig);
    } // Fl_Return_Button* btnCloseConfig
    { btnResetConfig = new Fl_Button(5, 432, 130, 22, _("Restore defaults"));
